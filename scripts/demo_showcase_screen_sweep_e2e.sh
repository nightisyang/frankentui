...
SCREENS=(
    ...
    "16|mermaid_showcase|Mermaid Showcase"
    "17|mermaid_mega_showcase|Mermaid Mega Showcase"
    "18|visual_effects|Visual Effects"
    "19|responsive|Responsive"
    "20|log_search|Log Search"
    "21|notifications|Notifications"
    "22|action_timeline|Action Timeline"
    "23|sizing|Sizing"
    "24|layout_inspector|Layout Inspector"
    "25|text_editor|Text Editor"
    "26|mouse_playground|Mouse Playground"
    "27|form_validation|Form Validation"
    "28|virtualized_search|Virtualized Search"
    "29|async_tasks|Async Tasks"
    "30|theme_studio|Theme Studio"
    "31|snapshot_player|Snapshot Player"
    "32|performance_hud|Performance Challenge"
    "33|explainability_cockpit|Explainability Cockpit"
    "34|i18n_demo|i18n Demo"
    "35|voi_overlay|VOI Overlay"
    "36|inline_mode_story|Inline Mode Story"
    "37|accessibility_panel|Accessibility Panel"
    "38|widget_builder|Widget Builder"
    "39|command_palette_lab|Command Palette Lab"
    "40|determinism_lab|Determinism Lab"
    "41|hyperlink_playground|Hyperlink Playground"
    "42|kanban_board|Kanban Board"
)
